                    ...
                    [
                        html.Li(
                            [
                                ...
                                html.A('https://infomics.github.io/InfOmics/index.html', href = 'https://infomics.github.io/InfOmics/index.html', target = '_blank'),
                                ')'
                            ]
                        ),
                        html.Li(
                            [
                                ...
                                html.A('http://pinellolab.org/', href='http://pinellolab.org/', target = '_blank'),
                                ')' 
                            ]
                        ),
                    ], style = {'padding': '15px'}
