...
cleanName = ''.join([char for char in os.path.basename(os.path.normpath(genomeDir)) if char != "+"])
...
if not os.path.exists(fileDir+"/annotations/"+cleanName+"_ref.Annotations.bed"):
    copy(annotationFile, fileDir+"/annotations/"+cleanName+"_ref.Annotations.bed")
    
if is_vcf_given and not os.path.exists(fileDir+"/samplesID/samples_"+cleanName+"_ref+"+cleanName+"_"+enrichedName+".txt"):
    copy(sampleFile, fileDir+"/samplesID/samples_"+cleanName+"_ref+"+cleanName+"_"+enrichedName+".txt")
...
if is_vcf_given:
    ...
    if not os.path.exists("Genomes/"+cleanName+"_ref+"+cleanName+"_"+enrichedName):
        os.mkdir(fileDir+"/Genomes/"+cleanName+"_ref+"+cleanName+"_"+enrichedName)
...
if is_vcf_given:
    ...
    if not os.path.exists(fileDir+"/dictionaries/"+cleanName+"_ref+"+cleanName+"_"+enrichedName):
        os.mkdir(fileDir+"/dictionaries/"+cleanName+"_ref+"+cleanName+"_"+enrichedName)
